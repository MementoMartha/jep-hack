...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_CELESTE	; RB_CYANMON, though slightly edited
	...
	const PREDEFPAL_LANDMARK_SIGN ; Originally PREDEFPAL_BETA_POKEGEAR but I have hijacked this for my own shit because it's a clone of the RB_PINKMON palette lol
	const PREDEFPAL_47
	...
	const PREDEFPAL_NAVEL_ROCK
	const PREDEFPAL_NAVEL_ROCK_MORN
	const PREDEFPAL_CELESTE_MORN
	const PREDEFPAL_VOLCANIC
	const PREDEFPAL_BRUNSWICK
	const PREDEFPAL_BRUNSWICK_MORN
	const PREDEFPAL_JADE
	const PREDEFPAL_JADE_MORN
