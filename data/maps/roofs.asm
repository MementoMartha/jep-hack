...
; values are indexes for Roofs (see below)
	...
	db ROOF_GOLDENROD ; 29 (Brunswick area)
	db ROOF_AZALEA    ; 30 (One Island)
	db ROOF_AZALEA	  ; 31 (Two Island)
	db ROOF_AZALEA	  ; 32 (Three Island)
	db ROOF_AZALEA	  ; 33 (Four Island)
	db ROOF_AZALEA	  ; 34 (Five Island)
	db ROOF_AZALEA	  ; 35 (Six Island)
	db ROOF_AZALEA	  ; 36 (Seven Island)
	db ROOF_AZALEA	  ; 37 (Navel Rock)
	db ROOF_NEW_BARK  ; 38 (Silent Hills)
	db ROOF_VIOLET    ; 39 (Old City)
	db ROOF_NEW_BARK  ; 40 (Savoy City)
	db ROOF_NEW_BARK  ; 41 (Coral City)
	db ROOF_NEW_BARK  ; 42 (Ruddy Town)
	db ROOF_NEW_BARK  ; 43 (Ochre Town)
	db ROOF_NEW_BARK  ; 44 (Sunglow City)
	...
	db ROOF_NEW_BARK  ; 49 (New Mt Silver)
