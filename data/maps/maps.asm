...
MapGroup_Cinnabar:
	...
	map CinnabarVolcanoSummit, TILESET_CAVE_VOLCANIC, ROUTE, LANDMARK_CINNABAR_ISLAND, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN ; Should be fishgroup_volcano or something idk. also music needs changing.
