...
MapGroup_Celeste:		; 27
	...
	map CelesteHill, TILESET_FOREST_KANTO, TOWN, LANDMARK_CELESTE_HILL, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CelesteHillOutside, TILESET_FOREST_KANTO, TOWN, LANDMARK_CELESTE_HILL, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
