...
MapGroup_Citrine:		; 27
	...
	map CitrineCity, TILESET_CITRINE, TOWN, LANDMARK_CITRINE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BrunswickTrail, TILESET_CITRINE, ROUTE, LANDMARK_BRUNSWICK_TRAIL, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BrunswickGlade, TILESET_FOREST_KANTO, ROUTE, LANDMARK_BRUNSWICK_TRAIL, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BrunswickGrotto, TILESET_FOREST_KANTO, ROUTE, LANDMARK_BRUNSWICK_GROTTO, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map GarnetCavern1F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_GARNET_CAVERN, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GarnetCavern2F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_GARNET_CAVERN, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GarnetCavernB1F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_GARNET_CAVERN, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CitrineTradebackHouse, TILESET_HOUSE, INDOOR, LANDMARK_CITRINE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CITRINE_MAPS

MapGroup_Celeste:		; 27
	table_width MAP_LENGTH, MapGroup_Celeste
	map CitrineCelesteGate, TILESET_GATE, GATE, LANDMARK_CITRINE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CelesteHill, TILESET_CELESTE, TOWN, LANDMARK_CELESTE_HILL, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CelesteHillOutside, TILESET_CELESTE, TOWN, LANDMARK_CELESTE_HILL, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CelesteHillCave, TILESET_ICE_PATH, CAVE, LANDMARK_CELESTE_HILL_CAVE, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
