...
; pointers to the first map of each map group
	...
	dw MapGroup_Celeste 	; 27
	dw MapGroup_Brunswick	; 27
	...
	dw MapGroup_NavelRock	; 35
	dw MapGroup_SilentHills ; 36
	dw MapGroup_OldCity		; 37
	dw MapGroup_SavoyCity	; 38
	dw MapGroup_CoralCity	; 39
	dw MapGroup_RuddyTown   ; 40
	dw MapGroup_OchreTown	; 41
	dw MapGroup_SunglowCity ; 42
	dw MapGroup_BlueForest  ; 43
...
MapGroup_Cinnabar:
	...
	map CinnabarVolcanoFloors, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_CINNABAR_ISLAND, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_OCEAN ; All of these should use a volcano fishgroup for the lava or something
	map CinnabarVolcano4F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_CINNABAR_ISLAND, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_OCEAN ;     Also the music needs a change lol
	map CinnabarVolcanoSummit, TILESET_CAVE_VOLCANIC, ROUTE, LANDMARK_CINNABAR_ISLAND, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CinnabarVolcanoB2FGym, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
...
MapGroup_FastShip:
	...
	map MtMoonCrater, TILESET_CAVE, INDOOR, LANDMARK_MT_MOON_CRATER, MUSIC_MT_MOON_SQUARE, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; fishgroup prolly custom - supposed to use MUSIC_MT_MOON_CRATER but there was a build error
	map MtMoonCraterDepths, TILESET_CAVE, INDOOR, LANDMARK_MT_MOON_CRATER, MUSIC_MT_MOON_SQUARE, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; fishgroup prolly custom - supposed to use MUSIC_CRYSTAL_CRATER but there was a build error
...
MapGroup_Indigo:
	...
	map IndigoPlateau, TILESET_PLATEAU, TOWN, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Citrine:		; 27
	...
	map CitrineCity, TILESET_CITRINE, TOWN, LANDMARK_CITRINE_CITY, MUSIC_FOURISLAND, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CitrineMart, TILESET_NIHON_MART, INDOOR, LANDMARK_CITRINE_CITY, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CitrinePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CITRINE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CitrineTradebackHouse, TILESET_HOUSE, INDOOR, LANDMARK_CITRINE_CITY, MUSIC_FOURISLAND, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CitrinePort, TILESET_SEVII_PORT, INDOOR, LANDMARK_CITRINE_CITY, MUSIC_FOURISLAND, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CITRINE_MAPS

MapGroup_Celeste:		; 27
	table_width MAP_LENGTH, MapGroup_Celeste
	map CitrineCelesteGate, TILESET_GATE, GATE, LANDMARK_CITRINE_CITY, MUSIC_FOURISLAND, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CelesteHill, TILESET_CELESTE, TOWN, LANDMARK_CELESTE_HILL, MUSIC_FOURISLAND, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CelesteHillOutside, TILESET_CELESTE, TOWN, LANDMARK_CELESTE_HILL, MUSIC_FOURISLAND, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CelesteHillCave, TILESET_ICE_PATH, CAVE, LANDMARK_CELESTE_HILL_CAVE, MUSIC_FOURISLAND, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	assert_table_length NUM_CELESTE_MAPS
	
MapGroup_Brunswick:		; 27
	table_width MAP_LENGTH, MapGroup_Brunswick
	map BrunswickTrail, TILESET_CITRINE, TOWN, LANDMARK_BRUNSWICK_TRAIL, MUSIC_FOURISLAND, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BrunswickGlade, TILESET_FOREST_KANTO, FOREST, LANDMARK_BRUNSWICK_TRAIL, MUSIC_FOURISLAND, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BrunswickGrotto, TILESET_FOREST_KANTO, FOREST, LANDMARK_BRUNSWICK_GROTTO, MUSIC_FOURISLAND, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map GarnetCavern1F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_GARNET_CAVERN, MUSIC_FOURISLAND, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GarnetCavern2F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_GARNET_CAVERN, MUSIC_FOURISLAND, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GarnetCavernB1F, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_GARNET_CAVERN, MUSIC_FOURISLAND, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_BRUNSWICK_MAPS
...
MapGroup_FiveIsland:	; 32
	...
	map FiveIslandMeadow, TILESET_SEVII, ROUTE, LANDMARK_FIVE_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MemorialPillar, TILESET_SEVII, ROUTE, LANDMARK_FIVE_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map WaterLabyrinth, TILESET_SEVII, ROUTE, LANDMARK_FIVE_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ResortGorgeous, TILESET_SEVII, ROUTE, LANDMARK_FIVE_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_SixIsland:	; 33
	...
	map WaterPath, TILESET_SEVII, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RuinValley, TILESET_SEVII, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DottedHole, TILESET_CAVE, CAVE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GreenPath, TILESET_SEVII, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PatternBush, TILESET_CAVE, CAVE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OutcastIsland, TILESET_CAVE, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AlteringCave, TILESET_CAVE, CAVE, LANDMARK_FIVE_ISLAND, MUSIC_SEVII, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_SIX_ISLAND_MAPS

MapGroup_SevenIsland:	; 34
	table_width MAP_LENGTH, MapGroup_SevenIsland
	map SevenIsland, TILESET_SEVII, TOWN, LANDMARK_SEVEN_ISLAND, MUSIC_SIXISLAND, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CanyonEntrance, TILESET_CAVE, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SevaultCanyon, TILESET_CAVE, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TanobyRuins, TILESET_CAVE, ROUTE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TanobyChambers, TILESET_CAVE, CAVE, LANDMARK_SIX_ISLAND, MUSIC_SEVII, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_SEVEN_ISLAND_MAPS
	
MapGroup_NavelRock:		
	table_width MAP_LENGTH, MapGroup_NavelRock
	map NavalRockExterior, TILESET_SEVII, TOWN, LANDMARK_SIX_ISLAND, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	assert_table_length NUM_NAVEL_ROCK_MAPS
...
MapGroup_SilentHills:
	...
	map QuietCave, TILESET_LUSHCAVE, ROUTE, LANDMARK_QUIET_CAVE, MUSIC_NIHONTIME, TRUE, PALETTE_AUTO, FISHGROUP_POND
	...
	map JadeRoute, TILESET_NIHON_01, ROUTE, LANDMARK_JADE_ROUTE, MUSIC_NIHONTIME, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_RuddyTown:
	...
	map Route53RuddyTownGate, TILESET_NIHON_GATE, GATE, LANDMARK_ROUTE_53, MUSIC_PEACEFULTHEME, FALSE, PALETTE_DAY, FISHGROUP_NONE 
	map Route54RuddyTownGate, TILESET_NIHON_GATE, GATE, LANDMARK_ROUTE_50, MUSIC_PEACEFULTHEME, FALSE, PALETTE_DAY, FISHGROUP_NONE ; needs new landmark when route is made
	assert_table_length NUM_RUDDY_TOWN_MAPS
	
MapGroup_OchreTown:
	table_width MAP_LENGTH, MapGroup_OchreTown
	map Route53, TILESET_NIHON_FONT, ROUTE, LANDMARK_ROUTE_53, MUSIC_MOBILE_ADAPTER_MENU, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_OCHRE_TOWN_MAPS
...
MapGroup_MtSilver:
	...
	map MtSilver, TILESET_NIHON_01, TOWN, LANDMARK_MT_SILVER, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_LAKE ; See above comment. Should these share music? Should THIS use the Indigo Plateau music?
	map MtSilverInterior1F, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map MtSilverInterior2F, TILESET_CAVE, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MtSilverInterior3F, TILESET_ICE_PATH, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MtSilver2FOutside, TILESET_NIHON_01, TOWN, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map MtSilver3FOutside, TILESET_NIHON_SNOWY, TOWN, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map MtSilverSummit, TILESET_NIHON_SNOWY, TOWN, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map MtSilverItemRooms, TILESET_CAVE_VOLCANIC, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
