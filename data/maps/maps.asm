...
MapGroup_FastShip:
	...
	map MtMoonCrater, TILESET_CAVE, INDOOR, LANDMARK_MT_MOON_CRATER, MUSIC_MT_MOON_CRATER, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; fishgroup prolly custom
	map MtMoonCraterDepths, TILESET_CAVE, INDOOR, LANDMARK_MT_MOON_CRATER, MUSIC_CRYSTAL_CRATER, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; fishgroup prolly custom
