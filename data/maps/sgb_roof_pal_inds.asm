...
; entries correspond to map groups
	...
	db PREDEFPAL_CELESTE
	db PREDEFPAL_BRUNSWICK
...
; entries correspond to map groups, this time morning palettes. NEW FEATURE YIPPEE
	...
	db PREDEFPAL_CELESTE_MORN
	db PREDEFPAL_BRUNSWICK_MORN
	...
	db PREDEFPAL_JADE_MORN
	db PREDEFPAL_GATES_NIHON_MORN
	assert_table_length NUM_MAP_GROUPS + 1