...
;	map_attributes GoldenrodPokecenter1F, GOLDENROD_POKECENTER_1F, $00, 0
	...
	map_attributes GarnetCavern2F, GARNET_CAVERN_2F, $00, 0 ; Bank 2
	map_attributes GarnetCavernB1F, GARNET_CAVERN_B1F, $00, 0 ; Bank 2
	...
	map_attributes OneIsland, ONE_ISLAND, $07, SOUTH | EAST ; Bank 2
	connection south, TreasureBeach, TREASURE_BEACH, 0
	connection east, KindleRoad, KINDLE_ROAD, -24
	map_attributes TreasureBeach, TREASURE_BEACH, $07, NORTH ; Bank 2
	connection north, OneIsland, ONE_ISLAND, 0
	map_attributes KindleRoad, KINDLE_ROAD, $07, NORTH | WEST; Bank 2
	connection north, MtEmberExterior, MT_EMBER_EXTERIOR, -5
	connection west, OneIsland, ONE_ISLAND, 24
	map_attributes MtEmberExterior, MT_EMBER_EXTERIOR, $09, SOUTH ; Bank 2
	connection south, KindleRoad, KINDLE_ROAD, 5
